...
Scan a source code directory for hardcoded secrets. If Semgrep is installed, also runs SAST analysis. Install Semgrep for full coverage: https://semgrep.dev
